...
export const GAMES = [
  ...
  },
  {
    ...
    tagline: 'Forage & trade · v1',
    blurb: 'Forage the wood by day, haggle at the counter by evening. The rent never gets smaller.',
    about: [
      'You have taken the lease on a shop at the edge of the wood, and thirty days to make it pay. Every morning you walk out to gather — bark and berries near the door, clay and flint at the ford, and ironwood and amber further north than your tools will yet let you go. Stamina is the whole budget: it goes on walking and on gathering, and when it runs out you are carried home with whatever you managed.',
    ...
    tips: [
      'Walk home before the stamina runs out — the walk back costs too.',
      ...
      'Crafted goods beat their materials. The workbench pays for itself by the second rent.',
    ],
  },
